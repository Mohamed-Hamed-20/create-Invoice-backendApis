...
exports.HtmlTEXTInvoice = exports.restpasswordTemplet = exports.SignUpTemplet = void 0;
...
exports.SignUpTemplet = SignUpTemplet;
const restpasswordTemplet = (code) => `<!DOCTYPE html>
...
exports.restpasswordTemplet = restpasswordTemplet;
const HtmlTEXTInvoice = (invoice) => {
    return `<p>Dear ${invoice.userName},</p>
        <p>We are pleased to inform you that your purchase was successful. Please find attached your invoice.</p>
        <p>Thank you for shopping with us!</p>`;
};
exports.HtmlTEXTInvoice = HtmlTEXTInvoice;
